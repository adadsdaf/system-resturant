...
public class LicenseData
{
    ...
    public bool IsExpired => !string.IsNullOrEmpty(ExpiryDate) && DateTime.Parse(ExpiryDate) < DateTime.Now;
    ...
    public int RemainingDays
    {
        get
        {
            ...
            var days = (DateTime.Parse(ExpiryDate) - DateTime.Now).Days;
            return days > 0 ? days : 0;
        }
    }

    public bool IsDeviceMatch(string currentFingerprint) => DeviceFingerprint == currentFingerprint;
