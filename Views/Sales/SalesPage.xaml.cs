...
public partial class SalesPage : Page
{
    ...
    private async Task LoadAsync()
    {
        try
        {
            ...
            var list = orders.Select(o => new
            {
                ...
                total_fmt = $"{(decimal)o.total_amount:N2} {_currency}",
                disc_fmt  = $"{(decimal)o.discount_amount:N2}",
                tax_fmt   = $"{(decimal)o.tax_amount:N2}",
    ...
    private async void Filter_Changed(object s, SelectionChangedEventArgs e)
    {
